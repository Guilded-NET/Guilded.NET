...
namespace Guilded.NET.Util {
    ...
    public static class ChannelId {
        ...
        /// <param name="client">Client to send the message with</param>
        /// <param name="message">Message itself</param>
        //public static async Task<Message> GetMessageAsync(this DMChannel channel, Guid messageId) =>
        //    await channel.ParentClient.GetMessageAsync(channel.Id, messageId);
        /// <summary>
        /// Sends a message to the specific channel. Sync version of <see cref="GetMessageAsync"/>.
        /// </summary>
        /// <param name="channel">Channel to send to</param>
        /// <param name="client">Client to send the message with</param>
        /// <param name="message">Message itself</param>
        //public static Message GetMessage(this DMChannel channel, Guid messageId) =>
        //    channel.ParentClient.GetMessage(channel.Id, messageId);
        /// <summary>
        /// Deletes a message posted in the chat.
        /// </summary>
        /// <param name="channel">Channel to delete message in</param>
        ...
        /// <param name="client">Client to send the message with</param>
        /// <param name="message">Message itself</param>
        //public static async Task<Message> GetMessageAsync(this ThreadChannel channel, Guid messageId) =>
        //    await channel.ParentClient.GetMessageAsync(channel.Id, messageId);
        /// <summary>
        /// Sends a message to the specific channel. Sync version of <see cref="GetMessageAsync"/>.
        /// </summary>
        ...
        /// <param name="client">Client to send the message with</param>
        /// <param name="message">Message itself</param>
        //public static Message GetMessage(this ThreadChannel channel, Guid messageId) =>
        //    channel.ParentClient.GetMessage(channel, messageId);
        /// <summary>
        /// Deletes a message posted in the chat.
        /// </summary>

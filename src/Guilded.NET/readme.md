...
> ## To-do
> - [x] **Create team related things**: channels, groups, categories, roles, etc..
> - [ ] **Manage messages**: delete messages, create threads, archive threads, etc..
> - [ ] **Assign client to every event, given object, etc..**
> - [x] **More message features:** embeds(!!!), images, mentions, channel mentions.
> - [x] **Instant build:** Template for .NET Core MSBuild `dotnet new`.
> - [x] **Make stuff easier:** easier time creating new messages, getting message content.
> - [x] **.NET default things edited:** comparing objects, `ToString()` changes.
> - [x] **.NET bot config:** configure bot features, such as prefixes, commands, statuses, etc..

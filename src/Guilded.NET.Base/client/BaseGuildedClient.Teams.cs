...
namespace Guilded.NET.Base
{
    public abstract partial class BaseGuildedClient
    {
        ...
        public abstract Task GiveRoleAsync(GId memberId, uint roleId);
        /// <summary>
        ...
        public abstract Task<long> GiveXpAsync(GId userId, short xpAmount);
        #endregion
        ...
        /// <param name="xpAmount">Amount of XP required for the role</param>

...
public class StreamChannel : ServerChannel, IChatChannel
{
    #region Constructors
    /// <summary>
    /// Initializes a new instance of <see cref="StreamChannel" /> from the specified JSON properties.
    /// </summary>
    ...
    /// <returns>New <see cref="StreamChannel" /> JSON instance</returns>

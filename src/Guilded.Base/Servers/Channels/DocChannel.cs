...
public class DocChannel : ServerChannel
{
    ...
    #region Methods
    /// <inheritdoc cref="BaseGuildedClient.GetDocsAsync(Guid, uint?, DateTime?)" />
    ...
    /// <inheritdoc cref="BaseGuildedClient.GetDocAsync(Guid, uint)" />
    ...
    /// <inheritdoc cref="BaseGuildedClient.CreateDocAsync(Guid, string, string)" />

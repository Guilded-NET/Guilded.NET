...
public class ChatChannel : ServerChannel, IChatChannel
{
    #region Constructors
    /// <summary>
    /// Initializes a new instance of <see cref="ChatChannel" /> from the specified JSON properties.
    /// </summary>
    ...
    /// <returns>New <see cref="ChatChannel" /> JSON instance</returns>

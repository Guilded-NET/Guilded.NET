...
/// <summary>
/// Represents an event that occurs when <see cref="Member">a member</see> leaves <see cref="Server">a server</see> or gets removed from it.
/// </summary>
...
/// <seealso cref="Member" />
public class MemberRemovedEvent : BaseModel
{
    #region Properties
    /// <summary>

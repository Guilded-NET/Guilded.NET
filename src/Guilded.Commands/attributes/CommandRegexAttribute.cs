...
/// <summary>
/// Declares the <see cref="System.Text.RegularExpressions.Regex" /> that will match the <see cref="CommandParamAttribute">command arguments</see> with <see cref="Match" /> or <see cref="MatchCollection" /> types.
/// </summary>
/// <remarks>
/// <para>This will only be used by the <see cref="CommandParamAttribute">command arguments</see> that have either <see cref="Match" /> or <see cref="MatchCollection" /> as their parameter types.</para>
/// </remarks>
/// <example>
/// <para>The following is an example of the <see cref="CommandRegexAttribute" /> being used with a <see cref="CommandParamAttribute">command argument</see> that has <see cref="MatchCollection" /> parameter type.</para>
...
public sealed class CommandRegexAttribute : Attribute
{
    ...
    /// Declares the <see cref="System.Text.RegularExpressions.Regex" /> that will match the <see cref="CommandParamAttribute">command arguments</see> with <see cref="Match" /> or <see cref="MatchCollection" /> types.
    /// </summary>
    /// <param name="regex">The instance of <see cref="System.Text.RegularExpressions.Regex" /> for matching the  <see cref="CommandParamAttribute">command argument</see> values</param>

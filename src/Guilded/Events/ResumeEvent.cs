...
/// <summary>
/// Represents an event that occurs once all missed events were <see cref="BaseGuildedConnection.LastMessageId">resumed</see>.
/// </summary>
/// <seealso cref="WelcomeEvent" />
/// <seealso cref="GuildedSocketMessage" />
/// <seealso cref="GuildedSocketException" />
/// <seealso cref="BaseGuildedConnection.LastMessageId" />

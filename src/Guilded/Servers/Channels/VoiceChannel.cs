...
public class VoiceChannel : ServerChannel, IChatChannel
{
    #region Constructors
    /// <summary>
    /// Initializes a new instance of <see cref="VoiceChannel" /> from the specified JSON properties.
    /// </summary>
    ...
    /// <returns>New <see cref="VoiceChannel" /> JSON instance</returns>

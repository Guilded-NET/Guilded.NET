...
public interface IEventInfo<out T>
{
    ...
    /// <summary>
    /// Gets the transformation function for the <see cref="GuildedSocketMessage.RawData">data</see> of the <see cref="IEventInfo{T}">event</see>.
    /// </summary>
    /// <value>The transformation function for the <see cref="GuildedSocketMessage.RawData">data</see> of the <see cref="IEventInfo{T}">event</see></value>
